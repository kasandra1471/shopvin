...
<body>
   ...
   <div class="site-wrap" style="z-index: 5;">
      ...
      <div class="site-navbar bg-white py-2">
         ...
         <div class="container">
            <div class="d-flex align-items-center justify-content-between">
               <div class="logo">
                  <div class="site-logo">
                     <a href="${pageContext.request.contextPath}/" class="js-logo-clone">MAIVIN</a>
                  </div>
               </div>
                  ...
                  <nav class="site-navigation text-right text-md-center"
                     ...
                     <ul class="site-menu js-clone-nav d-none d-lg-block">
                           ...
                           <ul class="dropdown">
                              ...
                              <li class="has-children"><a href="/product/bottom/bottom">BOTTOM</a>
                                 <ul class="dropdown">
                                    ...
                                    <li><a href="/product/bosttom/slacks">SLACKS</a></li>
                                 </ul></li>
                        ...
                        <li class="has-children active" >
               				...
               				<li>
               				<a href="/">
               				<span class="icon-user"> User Profile</span> 
               				</a>              				 
              	 			</li>
							...
							<form role="form" method="post" action="/customLogout">
								...
								<a>
								<span>
								<button style="margin-left: 5mm; border: 1px solid skyblue;
										background-color: white;
										color: gray;"> 로그아웃</button>
								</span>								
								</a>
               ...
               <div class="icons">
                  ...
                  <a style="margin-left: 12px;" href="${pageContext.request.contextPath}/register.jsp"> 
