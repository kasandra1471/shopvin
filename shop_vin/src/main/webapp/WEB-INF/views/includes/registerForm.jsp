...
<body>
   <article class="container">
      ...
      <div style="margin: 0 auto;" class="col-sm-6 col-md-offset-3">
         ...
         <form role="form" action="/register" method="post" method="get">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
               <label for="inputName">주소</label><br> <input type="text"
                  class="form-control" id="sample4_postcode" name="zipCode"
                  placeholder="우편번호"> <input type="button"
                  class="form-control" onclick="sample4_execDaumPostcode()"
                  value="우편번호 찾기"><br> <input type="text"
                  id="sample4_roadAddress" name="userAddr" class="form-control"
                  placeholder="도로명주소"> <input type="text"
                  id="sample4_jibunAddress" name="userAddr2" class="form-control"
                  placeholder="지번주소"> <span id="guide"
                  style="color: #999; display: none"></span> <input type="text"
                  id="sample4_detailAddress" name="detailAddr" class="form-control"
                  placeholder="상세주소"> <input type="text"
                  id="sample4_extraAddress" name="extraAddr" class="form-control"
                  placeholder="참고항목">
            </div>
