...
<body>
	<div class="block-4"
		...
		<a style="color: #5D5D5D;" href="/product/top/tee">Tee<span
			class="count "> (35)</span></a> <a style="color: #5D5D5D;"
			href="/product/top/shirt">&nbsp;&nbsp;&nbsp;&nbsp; Shirt <span
			class="count "> (23)</span></a> <a style="color: red; font-weight: bold;"
	...
	<form id="actionForm" action="/product/top/knit" method="get">
