...
<body>
	<div class="block-4"
		...
		<a style="color: #5D5D5D;" href="/product/bottom/denim">Denim <span
			class="count "> (9)</span></a> <a style="color: #5D5D5D;"
			href="/product/bottom/slacks">&nbsp;&nbsp;&nbsp;&nbsp;Slacks <span
	...
	<form id="actionForm" action="/product/bottom/bottom" method="get">
