...
<body>
	<div class="block-4"
		...
		<h2>
			<a style="color: black">Acc</a>
		</h2>
		<a style="color: #5D5D5D;" href="/product/acc/hat">Hat <span
			class="count "> (9)</span></a> <a style="color: #5D5D5D;"
			href="/product/acc/ring">&nbsp;&nbsp;&nbsp;&nbsp;Ring <span
			class="count "> (8)</span></a> <a style="color: #5D5D5D;"
			href="/product/acc/neckLace">&nbsp;&nbsp;&nbsp;&nbsp;Necklace <span
			class="count "> (9)</span></a> <a style="color: red; font-weight: bold;"
			href="/product/acc/bag">&nbsp;&nbsp;&nbsp;&nbsp;Bag <span
			class="count "> (6)</span></a> <a style="color: #5D5D5D;"
			href="/product/acc/belt">&nbsp;&nbsp;&nbsp;&nbsp;Belt <span
	...
	<form id="actionForm" action="/product/acc/bag" method="get">
