...
<body>
	<div class="block-4"
		...
		<a style="color: #5D5D5D;" href="/product/acc/hat">Hat <span
			class="count "> (9)</span>
		</a> <a style="color: #5D5D5D;" href="/product/acc/ring">&nbsp;&nbsp;&nbsp;&nbsp;Ring
			<span class="count "> (8)</span>
		</a> <a style="color: red; font-weight: bold;"
			href="/product/acc/neckLace">&nbsp;&nbsp;&nbsp;&nbsp;Necklace <span
			class="count "> (9)</span>
		</a> <a style="color: #5D5D5D;" href="/product/acc/bag">&nbsp;&nbsp;&nbsp;&nbsp;Bag
			<span class="count "> (6)</span>
		</a> <a style="color: #5D5D5D;" href="/product/acc/belt">&nbsp;&nbsp;&nbsp;&nbsp;Belt
	...
	<form id="actionForm" action="/product/acc/neckLace" method="get">
