...
<body>
	<div class="block-4"
		...
		<a style="color: #5D5D5D;" href="/product/acc/hat">Hat <span
			class="count "> (9)</span>
		</a> <a style="color: red; font-weight: bold;" href="/product/acc/ring">&nbsp;&nbsp;&nbsp;&nbsp;Ring
			<span class="count "> (8)</span>
		</a> <a style="color: #5D5D5D;" href="/product/acc/neckLace">&nbsp;&nbsp;&nbsp;&nbsp;Necklace
	...
	<form id="actionForm" action="/product/acc/ring" method="get">
