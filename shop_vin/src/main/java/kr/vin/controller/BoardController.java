...
// jsp 대비로 if~else 분기 처리가 필요 없음.
	@PostMapping("/writer")
	public String writer(BoardVO board, RedirectAttributes rttr, HttpServletRequest request) {
...
//		return "redirect:" + referer ;
	...
	@PostMapping("/qnawriter")
	public String qnawriter(BoardVO board, RedirectAttributes rttr, HttpServletRequest request) {
// @Controller 어노테이션이 붙고,
// 컴포넌트 스캔에 패키지가 지정되어 있다면,
// 매개변수 인자들은 스프링이 자동으로 생성 할당 함.
		log.info("writer : " + board);
